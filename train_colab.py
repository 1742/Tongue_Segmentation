...
from tools.dataloader_colab import MyDatasets
...
data_path = r'/content/drive/MyDrive/Colab Notebooks/Tongue_Segmentation/data/train'
...
if __name__ == '__main__':
    ...
    val_data = data_names[int(data_num * 0.7):int(data_num * 0.99)]
